...
class MainActivity : AppCompatActivity() {
    ...
    private fun initializeSdk(context: Context) {
        ...
        val params = ZoomSDKInitParams().apply {
            appKey = "pfwt7tD4Meap9hxwU6JGs1veI8U2an0M5BMG" // TODO: Retrieve your SDK key and enter it here
            appSecret = "6YbYx7GjUosyz9RWfTMAiHiKPzTFIS7IDgKN" // TODO: Retrieve your SDK secret and enter it here
            domain = "zoom.us"
